...
impl FrozenSharedOutputV1 {
    /// Exact economic terms hash verified in each contribution's native PoP.
    /// The Bulletproof statement itself does not carry this field.
