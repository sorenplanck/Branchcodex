...
impl ValidatedXmrSetup {
    /// Economic/network context verified for the claim proof, also required
    /// when authenticating the distinct refund-share proof for this setup.
    pub const fn proof_context_hash(&self) -> &[u8; 32] {
        &self.proof_context_hash
    }
    /// Settlement id.
...
pub fn validate_setup(
    ...
    Ok(ValidatedXmrSetup {
        ...
        binding_hash,
        proof_context_hash: context_hash,
    })
}
