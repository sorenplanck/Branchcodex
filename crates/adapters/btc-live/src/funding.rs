...
impl ArmedBitcoinFundingV1 {
    ...
    /// Public contract script authenticated by the retained Prepared record.
    /// Exposes no signed transaction, wallet key or alternative broadcaster.
    #[must_use]
    pub fn contract_script_pubkey(&self) -> &[u8] {
        self.prepared.contract_script_pubkey()
    }
