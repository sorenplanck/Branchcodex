...
impl DurableRouteSecretVaultV1 {
    ...
    pub fn create_production(
        ...
        fsync_capability_dir(&parent).map_err(|_| RouteSecretVaultError::Filesystem)?;
    ...
    pub fn put(
        ...
        match read_record(&self.root, &record_name) {
            Ok(existing) => {
                ...
                if bool::from(existing_scalar[..].ct_eq(&scalar_bytes[..])) {
            ...
            Err(RouteSecretVaultError::NotFound) => {
                ...
                if !bool::from(reopened_scalar[..].ct_eq(&scalar_bytes[..])) {
