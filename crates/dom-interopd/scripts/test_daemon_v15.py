#!/usr/bin/env python3
"""Validate the V15 development checkpoint: native components, daemon build and artifact checks. Never executes a live swap."""
import argparse
...
def main():
    ...
    evidence = ROOT / "artifacts" / "daemon-v15"
    evidence.mkdir(parents=True, exist_ok=True)
    out = Path(tempfile.mkdtemp(prefix=stamp + "-", dir=evidence))
    report = {"schema": 15, "status": "incomplete", "mode": "offline" if args.offline else "daemon",
              ...
              "limits": ["Passing this runner does not prove live chain swaps or 10/10 security.",
                         ...
                         "V15 mounts receiver observation/ingress, public extraction and native F7 sender finality; full bootstrap and sender scheduling remain incomplete.",
