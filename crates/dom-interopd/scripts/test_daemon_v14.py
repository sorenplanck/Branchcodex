#!/usr/bin/env python3
"""Validate the V14 development checkpoint: native components, daemon build and artifact checks. Never executes a live swap."""
import argparse
...
def main():
    ...
    evidence = ROOT / "artifacts" / "daemon-v14"
    evidence.mkdir(parents=True, exist_ok=True)
    out = Path(tempfile.mkdtemp(prefix=stamp + "-", dir=evidence))
    report = {"schema": 14, "status": "incomplete", "mode": "offline" if args.offline else "daemon",
              ...
              "limits": ["Passing this runner does not prove live chain swaps or 10/10 security.",
                         ...
                         "V14 implements universal sender adaptation/exposure/admission/0x12 and an F7 completion worker; the main root and receiver remain incomplete.",
