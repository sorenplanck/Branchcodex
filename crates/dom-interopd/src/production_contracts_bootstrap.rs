...
#[path = "production_bootstrap_v13.rs"]
pub(crate) mod producer_v13;
...
mod tests {
    ...
    pub(super) const RELAY_SECRETS: [[u8; 32]; 3] = [[0x11; 32], [0x12; 32], [0x13; 32]];
    const DOM_CHAIN_ID: [u8; 32] = [0x44; 32];

    pub(super) struct FixtureV1 {
        pub(super) expected: ExpectedContextV1,
        pub(super) roster: ProductionRelayRosterBundleV1,
        pub(super) secp: SecpContext,
        pub(super) bytes: Vec<u8>,
    }

    pub(super) fn fixture() -> FixtureV1 {
