...
#[cfg(feature = "production")]
mod production_bitcoin_runtime_v11;
#[cfg(feature = "production")]
...
#[cfg(feature = "production")]
mod production_xmr_graph_offer_v22;
#[cfg(feature = "production")]
mod production_xmr_graph_setup_v22;
#[cfg(feature = "production")]
mod production_xmr_inventory_v23;
#[cfg(feature = "production")]
mod production_xmr_recovery_driver_v12;
#[cfg(feature = "production")]
mod production_xmr_recovery_pump_v22;
#[cfg(feature = "production")]
mod production_xmr_recovery_source;
#[cfg(feature = "production")]
mod production_xmr_remote_sweep_v23;
#[cfg(feature = "production")]
mod production_xmr_round_runtime_v12;
#[cfg(feature = "production")]
mod production_xmr_sweep;
#[cfg(feature = "production")]
pub use production_xmr_funding_command_v12::{
    prepare_xmr_funding_command_v12, PrepareXmrFundingCommandErrorV12, PreparedXmrFundingReportV12,
    PREPARE_XMR_FUNDING_USAGE_V12,
};
#[cfg(feature = "production")]
pub use production_xmr_inventory_v23::{
    prepare_xmr_inventory_command_v23, PrepareXmrInventoryErrorV23, PreparedXmrInventoryReportV23,
    PREPARE_XMR_INVENTORY_USAGE_V23,
};
#[cfg(all(feature = "production", target_os = "linux"))]
#[allow(dead_code)] // Concrete driver; universal bootstrap wiring is in progress.
mod production_bitcoin_claim_driver;
#[cfg(feature = "production")]
#[cfg_attr(
    not(test),
    expect(
...
#[cfg(feature = "production")]
mod production_universal_actuator;
#[cfg(feature = "production")]
mod production_universal_leg_authority;
...
#[cfg(feature = "production")]
pub use production_contracts_bootstrap::producer_v13::{
    bootstrap_command_v13, BootstrapCommandErrorV13, BootstrapProgressV13,
};
#[cfg(feature = "production")]
...
#[cfg(feature = "production")]
mod production_time_inbox;
#[cfg(feature = "production")]
mod production_timer;
#[cfg(feature = "production")]
mod production_xmr_quorum;
#[cfg(feature = "production")]
mod relay_worker;
mod runtime;
...
pub use production_config::{
    bitcoin_prebroadcast_script_digest_v7, load_production_bootstrap_v11,
    load_production_create_bootstrap_v1, load_production_create_bootstrap_v10,
    load_production_create_bootstrap_v2, load_production_create_bootstrap_v3,
    load_production_create_bootstrap_v4, load_production_create_bootstrap_v5,
    load_production_create_bootstrap_v6, load_production_create_bootstrap_v7,
    load_production_create_bootstrap_v8, load_production_create_bootstrap_v9,
    load_production_reopen_bootstrap_v1, load_production_reopen_bootstrap_v10,
    load_production_reopen_bootstrap_v2, load_production_reopen_bootstrap_v3,
    load_production_reopen_bootstrap_v4, load_production_reopen_bootstrap_v5,
    load_production_reopen_bootstrap_v6, load_production_reopen_bootstrap_v7,
    load_production_reopen_bootstrap_v8, load_production_reopen_bootstrap_v9,
    production_f6_authority_bundle_digest_v8, ProductionBitcoinPrebroadcastPinsV7,
    ...
    ProductionRuntimeBoundsV1, ProductionUniversalBootstrapFieldsV11, ProductionUniversalLegV11,
    ValidatedProductionBootstrapV1, ValidatedProductionLayoutV1, MAX_PRODUCTION_BOOTSTRAP_BYTES_V1,
    MAX_PRODUCTION_F6_AUTHORITY_BUNDLE_BYTES_V8, MAX_PRODUCTION_RELATIVE_PATH_BYTES_V1,
    PRODUCTION_CREATE_CONFIG_FILE_V1, PRODUCTION_CREATE_CONFIG_FILE_V10,
    PRODUCTION_CREATE_CONFIG_FILE_V11, PRODUCTION_CREATE_CONFIG_FILE_V2,
    ...
    PRODUCTION_REOPEN_CONFIG_FILE_V10, PRODUCTION_REOPEN_CONFIG_FILE_V11,
    PRODUCTION_REOPEN_CONFIG_FILE_V2, PRODUCTION_REOPEN_CONFIG_FILE_V3,
    PRODUCTION_REOPEN_CONFIG_FILE_V4, PRODUCTION_REOPEN_CONFIG_FILE_V5,
    PRODUCTION_REOPEN_CONFIG_FILE_V6, PRODUCTION_REOPEN_CONFIG_FILE_V7,
    PRODUCTION_REOPEN_CONFIG_FILE_V8, PRODUCTION_REOPEN_CONFIG_FILE_V9,
    REFUND_ARMING_DATABASE_FILE_V1, SOLANA_ACTUATOR_DATABASE_FILE_V1,
...
pub use production_node::{
    ...
    read_production_secrets_v4_from_stdin, DomNodeEndpointV1, ProductionLegCredentialsV4,
    ProductionNodeBoundsV1, ProductionNodeConfigV1, ProductionSecretsV1, ProductionSecretsV2,
    ProductionSecretsV2ErrorV1, ProductionSecretsV3, ProductionSecretsV3ErrorV1,
    ProductionSecretsV4, ProductionSecretsV4Error, MAX_DOM_NODE_BEARER_BYTES_V1,
    MAX_DOM_NODE_ENDPOINT_BYTES_V1, MAX_DOM_NODE_NETWORK_BYTES_V1,
    MAX_PRODUCTION_F6_HSM_CREDENTIALS_PER_LEG_V3, MAX_PRODUCTION_NODE_CONFIG_BYTES_V1,
};
#[cfg(feature = "production")]
...
// The two leg authority bundle writers. Both formats had a decoder and no
// encoder at all, in any language, which is why no state directory outside a
// `#[cfg(test)]` fixture has ever held a real one.
#[cfg(feature = "production")]
pub use production_run::universal::{
    encode_bitcoin_leg_authority_bundle_v22, ProductionBitcoinLegBundleV22,
    ProductionBitcoinLegPinsV22, ProductionBitcoinLegResourcesV22,
};
#[cfg(feature = "production")]
...
#[cfg(feature = "production")]
mod production_route_topology;

#[cfg(feature = "production")]
#[allow(dead_code)] // Signer service ownership is not yet loaded by the V10 CLI.
mod production_solana_signer;

#[cfg(feature = "production")]
mod production_materializing_children;

#[cfg(feature = "production")]
mod production_route_services;
