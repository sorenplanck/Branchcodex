...
pub(super) const PAYOUT_COMMITMENT_DOMAIN: &[u8] = b"DOM-INTEROP/F6/PAYOUT-COMMITMENT/V2\0";
pub(super) const EVIDENCE_DOMAIN: &[u8] = b"DOM-INTEROP/F6/ADAPTER-FACE-EVIDENCE/V2\0";
const TERMS_EVIDENCE_DOMAIN: &[u8] = b"DOM-INTEROP/F6/TERMS-AUTHORITY-EVIDENCE/V2\0";

#[derive(Clone, Copy, PartialEq, Eq)]
pub(super) enum AdapterFaceLegV2 {
    Dom,
    Counterparty,
}
...
pub(crate) struct AdapterAuthenticatedRefundFaceV2 {
    pub(super) leg: AdapterFaceLegV2,
    pub(super) position: SettlementPositionV2,
    pub(super) settlement_id: Digest32,
    pub(super) session_id: Digest32,
    pub(super) terms_hash: Digest32,
    pub(super) face: RefundFaceV2,
    pub(super) evidence_digest: Digest32,
    pub(super) evidence_revision: u64,
}
...
pub(super) const fn direction_tag(direction: LegDirectionV1) -> u8 {
    match direction {
...
pub(super) fn digest(domain: &[u8], parts: &[&[u8]]) -> Result<Digest32, ProductionF6ErrorV2> {
