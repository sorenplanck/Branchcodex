...
pub(crate) trait RouteSupervisorStoreAuthorityV1 {
    ...
    fn accept_dom_compensation_v12(
        &mut self,
        _lease: RouteLeaseV1,
        _revision: u64,
        _leg: LegIdV1,
        _authority: &dom_scriptless_store::VerifiedXmrRecoveryExecutionAuthorityV12,
        _custody: &dom_scriptless_store::XmrRecoveryCustodyV11,
        _observed: &adapter_dom_real::VerifiedDomCompensationObservationV11,
        _now: u64,
...
impl RouteSupervisorStoreAuthorityV1 for ExclusiveRouteSupervisorStoreAuthorityV1 {
    ...
    fn accept_dom_compensation_v12(
        ...
        Ok(self
            .store
            .accept_dom_compensation_v12(lease, revision, leg, authority, custody, observed, now)?)
    }
...
impl<C: Clock> RouteSupervisorV1<C> {
    ...
    /// Productive compensation enters through native finality and the same
    /// retained graph owner. Generic events, timers and receipts cannot mark
    /// this terminal outcome, and no route write/lease handle is exposed.
    #[cfg(feature = "production")]
    pub(crate) fn record_dom_compensation_v12(
        &mut self,
        leg: LegIdV1,
        authority: &dom_scriptless_store::VerifiedXmrRecoveryExecutionAuthorityV12,
        custody: &dom_scriptless_store::XmrRecoveryCustodyV11,
        ...
        self.store.accept_dom_compensation_v12(
            self.lease, revision, leg, authority, custody, observed, now,
        )
    }
