...
impl SessionContextV1 {
    ...
    pub(crate) fn new(
        ...
        Self::from_public_inputs_v23(inputs, signing_share.public_key())
    }

    /// Internal public-data audit; callers must never export this as authority.
    pub(crate) fn from_public_inputs_v23(
        inputs: SessionContextInputsV1,
        local_key: &PublicKey,
    ) -> Result<Self> {
