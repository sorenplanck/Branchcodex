...
#[cfg(unix)]
pub use claim_driver::UnixBitcoinClaimTransportV6;
pub use claim_driver::{
    drive_bitcoin_claim_v6, BitcoinClaimDriverErrorV6, BitcoinClaimExchangePhaseV6,
    BitcoinClaimSigningPortV6, BitcoinClaimTransportV6,
};
pub use model::{
...
pub use participant_wire::{BitcoinClaimMessageV3, BITCOIN_CLAIM_MESSAGE_MAX_BYTES_V3};
pub use rpc::{
