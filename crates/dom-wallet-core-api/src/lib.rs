...
pub struct ScanBlock {
    ...
    /// Coinbase metadata. Absent only for the authenticated, economically empty
    /// Mainnet genesis identity; ordinary blocks retain their real coinbase.
    pub coinbase: Option<CoinbaseScanMetadata>,
