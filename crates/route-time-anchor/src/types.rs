...
impl RouteTimePolicyV2 {
    ...
    /// Requires registry-authenticated mainnet identities; grants only time bounds.
    pub fn from_registry_dom_xmr_v23(
        registry: &ResolvedRegistryV1,
        upstream: &SettlementTermsV1,
        downstream: &SettlementTermsV1,
        limits: RouteTimePolicyLimitsV2,
    ...
    fn from_registry_profile_v23(
        ...
        let downstream_counterparty = derive_counterparty(
            registry,
    ...
    pub(crate) fn validate_against(
        ...
        let expected = Self::from_registry_profile_v23(
            registry,
            upstream,
            downstream,
            self.limits,
