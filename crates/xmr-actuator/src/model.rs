...
pub enum XmrActuatorErrorV1 {
    ...
    /// The broadcast boundary permanently rejected the input or its response.
    /// This does not prove absence: an earlier send may have reached the chain.
    #[error("XMR broadcast boundary rejected")]
    BroadcastRejected,
